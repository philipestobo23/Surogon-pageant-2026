...
<div class="container-fluid col-md-11">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div id="swimsuit" class="card-header d-flex justify-content-between align-items-center text-white fw-bold">
                    <h3 class="text-center fw-bold mt-2" style="color:#0A4D68;"><i class="bi bi-hearts me-2 fs-4"></i> Swimwear Category </h3>
