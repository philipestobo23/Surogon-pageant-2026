...
@section('content')
    ...
    <style>
        .card {
            background: rgba(222, 228, 230, 0.86);
        }
    </style>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div id="swimsuit"
                        ...
                        <h3 class="text-center fw-bold mt-2" style="color:#0A4D68;"><i class="bi bi-hearts me-2 fs-4"></i>
                            Swimwear Category </h3>
                    ...
                    <div class="text-center text-muted fw-semibold mb-3">
                        <i class="bi bi-info-circle me-1"></i>
                        Reminder: Your scores will not be saved until you click <span class="text-primary"><i
                    ...
                    <div class="card-body">
                        <form id="swimsuit-form">
                            ...
                            <div class="d-flex flex-row flex-wrap justify-content-center gap-3 mb-5">
                                @foreach($data as $key => $datum)
                                    <div class="card shadow shadow-lg" style="width: 10rem;">
                                        <span
                                        ...
                                        <img src="{{ asset('cons/' . $key + 1 . '.jpg') }}"
                                            ...
                                            style="height:250px; object-fit: cover;background-color:#F0EBE3;">
                                        <div
                                            ...
                                            <div class="">
                                                <p class="card-text m-0 fw-bold text-primary fs-5 d-flex align-items-center">
                        ...
                        <div id="rank-table-container" class="row justify-content-center my-5" hidden>
                            ...
                            <div class="swim-print d-flex justify-content-center align-items-center mt-3">
...
@push('scripts')
    ...
    <script>
        function printDiv() {
            ...
            a.document.write(
                `<head><style>@media print { body { text-align: center; margin-top:50px; } table { margin: 0 auto; border-collapse: collapse; text-align: center; }
                            ...
                            .sign{border-bottom:2px solid black; padding-right:20px; padding-left:20px; width:fit-content; margin-top:15px; } .swim-print{display:none;} .judge-name { font-size: 25px; margin-top:20px } }</style></head>`
            );
            a.document.write('<body> <h1>Swimsuit Result<br>');
