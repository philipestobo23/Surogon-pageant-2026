        ...
        <div class="col-md-12">
            <div class="card">
                <div id="gown" class="card-header d-flex justify-content-between align-items-center fw-bold">
                    <h3 class="text-center fw-bold mt-2 d-flex align-items-center" style="color:#0A4D68;"><i class="bi bi-suit-heart-fill me-2 fs-4"></i> Formal Wear
                    </h3>
                                    ...
                                    <div
                                        ...
                                        <div class="">
                                            ...
                                            <input class="form-control border border-secondary border-2 fs-4 fw-bold"
                                                type="number" step="0.1" max="10" value="{{ $datum[2] }}" name="{{ $datum[3] }}">
                                        </div>
                                    </div>
                                </div>
                            @endforeach
