...
<div class="gown-page">
    ...
    <div class="gown-header">
        ...
        <div class="gown-reminder">
            ...
            <span><strong>Scoring Instruction:</strong> Assign a score from <strong>1.0</strong> to <strong>10.0</strong> for each contestant in the Evening Gown category. All scores are held temporarily and <strong>will not be recorded to the system</strong> until you press the <span class="gown-rem-submit"><i class="bi bi-floppy-fill me-1"></i>Submit Scores</span> button. Please ensure all entries are complete before submitting.</span>
        </div>
    </div>
    ...
    <form id="gown-form" hx-boost="false">
        ...
        <div class="gown-reminder gown-reminder-bottom">
            ...
            <span><strong>Final Review:</strong> Please carefully verify the score assigned to each contestant before proceeding. Once you press <span class="gown-rem-submit"><i class="bi bi-floppy-fill me-1"></i>Submit Scores</span>, your evaluations will be <strong>permanently recorded</strong> in the system. This action cannot be undone without administrator assistance.</span>
        </div>
