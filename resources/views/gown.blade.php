            ...
            <div class="col-md-12">
                <div class="card">
                    <div id="gown" class="card-header d-flex justify-content-between align-items-center fw-bold">
                        <h3 class="text-center fw-bold mt-2 d-flex align-items-center" style="color:#0A4D68;"><i
                                class="bi bi-suit-heart-fill me-2 fs-4"></i> Gown Category
                        </h3>
                        <a hx-target="body" hx-get="{{ route('home') }}"
                            class="btn btn-danger d-flex align-items-center fw-bold shadow">
                            <i class="bi bi-arrow-left text-white me-2"></i>Back</a>
                    </div>
                    ...
                    <div class="card-body">
                                        ...
                                        <div
                                            ...
                                            <div class="">
                                                ...
                                                <input class="form-control border border-secondary border-2 fs-4 fw-bold"
                                                    type="number" step="0.1" max="10" value="{{ $datum[2] }}"
                                                    name="{{ $datum[3] }}">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div id="rank-table-container" class="row justify-content-center my-5" hidden>
                            ...
                            <div class="gown-print d-flex justify-content-center align-items-center mt-3">
        ...
        function printDiv() {
            ...
            a.document.write(
                `<head><style>@media print { body { text-align: center; margin-top:50px; } table { margin: 0 auto; border-collapse: collapse; }
                            ...
                            .sign{border-bottom:2px solid black; padding-right:20px; padding-left:20px; width:fit-content; margin-top:15px; } .gown-print{display:none;} .judge-name { font-size: 25px; margin-top:20px } }</style></head>`
            );
            a.document.write('<body> <h1>Gown Result<br>');
